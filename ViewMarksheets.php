        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <img src="custom/img/marksheet.png" width="40px" alt="">  
              Marksheets For Class <b class="text-danger" id="setClassName"></b></h3>
              <a href="DownloadMarksheetGA?SectionID=<?php echo $_GET['SectionID'];?>&StudentID=all" target="_blank"><button class="btn btn-info pull-right">Download All Marksheet</button></a>
            </div>
            <div class="box-body">
...
<script src="custom/js/ViewMarksheets.js"></script>
<!-- page script -->
<script>
  $(function () {
