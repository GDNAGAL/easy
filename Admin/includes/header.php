        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Alexander Pierce ,mhksjdf  jkhdsjkfhh jkhdsf</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="AddStudents.php"><i class="fa fa-circle-o"></i> Add School</a></li>
            <li><a href="students.php"><i class="fa fa-circle-o"></i> View Schools</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="">
          ...
          <ul class="treeview-menu">
            <li><a href="AddTeacher.php"><i class="fa fa-circle-o"></i> Add Agent</a></li>
            <li><a href="teachers.php"><i class="fa fa-circle-o"></i> View Agents</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="" onclick="window.open('Classes.php','_self')">
